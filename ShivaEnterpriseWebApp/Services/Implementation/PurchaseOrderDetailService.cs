...
namespace ShivaEnterpriseWebApp.Services.Implementation
{
    public class PurchaseOrderDetailServiceImpl : IPurchaseOrderDetailServiceImpl
    {
        ...
        public async Task<(bool success, string message)> AddPurchaseOrderDetailDetailsAsync(List<PurchaseOrderDetail> purchaseorder, string authToken)
        {
            try
            {
                ...
                var url = urlCollections["baseUrl"].ToString() + urlCollections["addpurchaseorderdetailUrl"].ToString();
